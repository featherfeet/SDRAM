...
mkdir -p ./libraries/sdram_system_inst_avalon_bridge_pins_bfm/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/verbosity_pkg.sv"                                     -work sdram_system_inst_avalon_bridge_pins_bfm -cdslib ./cds_libs/sdram_system_inst_avalon_bridge_pins_bfm.cds.lib
  ncvlog -sv "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/altera_conduit_bfm.sv"                                -work sdram_system_inst_avalon_bridge_pins_bfm -cdslib ./cds_libs/sdram_system_inst_avalon_bridge_pins_bfm.cds.lib
