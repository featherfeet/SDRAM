...
# ACDS 13.0sp1 232 linux 2019.03.01.18:13:45
...
ensure_lib                                          ./libraries/sdram_system_inst_avalon_bridge_pins_bfm
vmap       sdram_system_inst_avalon_bridge_pins_bfm ./libraries/sdram_system_inst_avalon_bridge_pins_bfm
...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/altera_merlin_slave_translator.sv"                    -work new_sdram_controller_0_s1_translator    
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/altera_merlin_master_translator.sv"                   -work bridge_0_avalon_master_translator       
  ...
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/verbosity_pkg.sv"                                     -work sdram_system_inst_avalon_bridge_pins_bfm
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/altera_conduit_bfm.sv"                                -work sdram_system_inst_avalon_bridge_pins_bfm
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/verbosity_pkg.sv"                                     -work sdram_system_inst_reset_bfm             
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/altera_avalon_reset_source.sv"                        -work sdram_system_inst_reset_bfm             
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/verbosity_pkg.sv"                                     -work sdram_system_inst_clk_bfm               
  vlog  "$QSYS_SIMDIR/sdram_system_tb/simulation/submodules/altera_avalon_clock_source.sv"                        -work sdram_system_inst_clk_bfm               
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L rst_controller -L new_sdram_controller_0_s1_translator -L bridge_0_avalon_master_translator -L bridge_0 -L new_sdram_controller_0 -L up_clocks_0 -L new_sdram_controller_0_my_partner -L sdram_system_inst_avalon_bridge_pins_bfm -L sdram_system_inst_reset_bfm -L sdram_system_inst_clk_bfm -L sdram_system_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L rst_controller -L new_sdram_controller_0_s1_translator -L bridge_0_avalon_master_translator -L bridge_0 -L new_sdram_controller_0 -L up_clocks_0 -L new_sdram_controller_0_my_partner -L sdram_system_inst_avalon_bridge_pins_bfm -L sdram_system_inst_reset_bfm -L sdram_system_inst_clk_bfm -L sdram_system_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
